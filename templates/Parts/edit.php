...
<div class="row">
    <ol class="breadcrumb" style="width: 70rem;">
        ...
        <li><i class="far fa-edit"></i>Edit Inventory Item</li>
        <li><i class="fa fa-id-card-o"></i>P<?= h($part->id) ?></li>
    </ol>
    <div class="card" style="width: 70rem;">
        <div class="card-body">
            <h2 class="card-title">Edit Inventory Item</h2>
            <div class="card-text">
                <?= $this->Form->postLink(
                    __('Delete Inventory Item'),
                    ['action' => 'delete', $part->id],
                    ['confirm' => __('Are you sure you want to delete the Inventory Item: {0}?', "P".$part->id), 'class' => 'btn btn-danger']
                ) ?>
                <div class="pull-right"><div class="red">* </div>&nbsp;<div class = legend>Indicates mandatory inputs</div></div><p><br></p>
                <?= $this->Form->create($part) ?>
                <div class="form-group">
                    <label for="inv_id">Inventory Category</label>
