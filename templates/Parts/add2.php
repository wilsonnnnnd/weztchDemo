...
<div class="row">
    <ol class="breadcrumb" style="width: 70rem;">
        ...
        <li><i class="far fa-plus-square"></i>Add Inventory Item</li>
    </ol>
    <div class="card" style="width: 70rem;">
        <div class="card-body">
            <h5 class="card-title">Add Inventory Item</h5><div class="pull-right"><div class="red">* </div>&nbsp;<div class = legend>Indicates mandatory inputs</div></div><br>
            <div class="card-text">
