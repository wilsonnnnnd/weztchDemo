...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li><i class="far fa-edit"></i>Edit Invoice</li>
...
<div class="row">
    <div class="card" style="width: 85rem;">
        <div class="card-body">
            <h2 class="card-title">Edit Invoice</h2>
            <div class="card-text"><div class="pull-right"><div class="red">* </div>&nbsp;<div class = legend>Indicates mandatory inputs</div></div>
                <?= $this->Form->postLink(
                    __('Delete Invoice'),
                    ['action' => 'delete', $invoice->id],
                    ['confirm' => __('Are you sure you want to delete the invoice for {0}?', $invoice->customer->type_name . " (Invoice Date: " . $invoice->invoice_date . ")"), 'class' => 'btn btn-danger']
                ) ?>
                <p><br></p>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <?php echo $this->Form->control('cust_id', ['onchange'=>'changeJobList(this.value)','required' => true, 'options' => $arr_customers, 'label' => false, 'class' => 'form-control selectpicker-customer border']); ?>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="job_id">Service Job</label>
...
<script>
    function changeJobList(custid){
        ...
        $.ajax({
            type: 'get',
            url: window.location.href.substring(0,window.location.href.lastIndexOf('/')-5)+ '/servicejob/'+custid,
            datatype: 'json',
