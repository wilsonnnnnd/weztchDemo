...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li><i class="far fa-edit"></i>Edit Customer</li>
        ...
        <div class="card-body">
            ...
            <div class="card-text">
                <?= $this->Form->postLink(
                    ...
                    ['confirm' => __('Are you sure you want to delete {0}?', $customer->type_name." (".$customer->contact_name.")"), 'class' => 'btn btn-danger']
                ) ?>
                <p></p><div class="pull-right">&nbsp;<div class = legend>Indicates mandatory if option<p> to the left is selected</p></div></div><div class="red pull-right">* </div><br>
                ...
                <div class="input-group-append">
                    ...
                    <?php $options4 = array('Phone' => 'Phone', 'Email' => 'Email', 'Website' => 'Website', 'Facebook' => 'Facebook', 'Instagram' => 'Instagram', 'In Person' => 'In Person', 'Store Visit' => 'Store Visit', 'Other' => 'Other');
                ...
                <div class="form-row">
                    <div class="form-group col-md-5">
                        ...
                        <?php echo $this->Form->control('first_name', ['required' => false,'id'=>'first_name', 'maxlength' => 50, 'placeholder' => 'Maximum length: 50', 'label' => false, 'class' => 'form-control']); ?>
                    </div>
                    <div class="form-group col-md-5">
                        <label for="last_name">Last Name <div class = red>*</div></label>
                        <?php echo $this->Form->control('last_name', ['required' => false,'id'=>'last_name', 'maxlength' => 50, 'placeholder' => 'Maximum length: 50', 'label' => false, 'class' => 'form-control']); ?>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <?php echo $this->Form->control('email', ['required' => false,'id'=>'email', 'maxlength' => 100, 'placeholder' => 'Maximum length: 100', 'label' => false, 'class' => 'form-control']); ?>
                    </div>
                    <div class="form-group col-md-6">
...
<script>
    ...
    changecontact(<?php echo $customer->phone_no; ?>);
