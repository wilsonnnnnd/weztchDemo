            ...
            <div class="card-text">
                ...
                <div class="row gy-2 gx-3 align-items-center">
                    ...
                    <div class="col-auto">
                        ...
                        <div class="input-group-prepend">
                            <?= $this->Form->button ('Apply Discount', ['onclick' =>'changeTOTAL();this.disabled=true;return true;', 'type' =>'button','class'=>'btn btn-secondary'])?>
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="input-group-prepend">
...
<script>
        function fileValidation() {
           ...
           // var fi = document.getElementById('file');
            ...
            if (!allowedExtensions.exec(filePath) || file >= 10240  ) {
                    alert(
