 ...
 * JobTasksFixture
 */
class JobTasksFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'task_time' => ['type' => 'decimal', 'length' => 10, 'precision' => 1, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'task_cost' => ['type' => 'decimal', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        ...
        '_constraints' => [
            ...
            'job_tasks_ibfk_1' => ['type' => 'foreign', 'columns' => ['job_id'], 'references' => ['service_jobs', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
